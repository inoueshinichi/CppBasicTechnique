...
/*
 * st_line_bufferのなかで、現在文字が格納されている部分のサイズ
 */
static int st_current_used_size = 0;


/*
 * st_line_bufferの末尾に１文字追加する。
 * 必要とあれば、st_line_bufferの先の領域を拡張する
 */
static void add_character(char ch)
{
    ...
    {
        st_line_buffer = (char*)realloc(st_line_buffer,
